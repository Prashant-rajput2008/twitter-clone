let main_post = document.querySelector(".main_post")
let sec_post = document.querySelector(".sec_post")
let sub_but = document.querySelector(".sub_but")
...
sub_but.addEventListener("click" , ()=>{
    window.location.href = "subscribe.html" , "_blank";
})
